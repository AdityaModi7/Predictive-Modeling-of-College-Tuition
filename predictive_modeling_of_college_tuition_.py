# -*- coding: utf-8 -*-
"""Predictive Modeling of College Tuition .ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/16Nf6fgZzHaHJ9Dnzd54wM2AuImm-SaKd
"""
...
# load data
df = pd.read_csv('colleges_train (2).csv')
print(df.head())
...
test_data = pd.read_csv('colleges_test_features (2).csv')
